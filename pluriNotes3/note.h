...
protected:
     ...
     */
    Note (QString id, const QString& t, QDate dc, QDate ddm) : identificateur(id),titre(t), dateCreation(dc), dateDerniereModif(ddm), active(false), corbeille(false) {}
    /**
...
private :
     ...
     * \details Le constructeur est dans la partie privée afin que seul NoteManager puisse créer un article
     */
    Article (QString id, const QString& t, QDate dc, QDate ddm, const QString& te) : Note(id,t,dc,ddm), texte(te) {}
    /**
...
private :
     ...
     * \details Le constructeur est dans la partie privée afin que seul NoteManager puisse créer une tâche
     */
    Tache(QString id, const QString& t, QDate dc, QDate ddm, unsigned int p, QDate e, Statut s, const QString& a) : Note(id,t,dc,ddm), action (a), priorite(p), echeance(e), etat(s) {}
    /**
...
private :
     ...
     * \details Le constructeur est dans la partie privée afin que seul NoteManager puisse créer un article
     */
     Media(QString id, const QString& t, QDate dc, QDate ddm, const QString& d, const QString& c, mType ty) : Note(id,t,dc,ddm), description(d), chemin(c), typeMedia(ty) {}
    /**
